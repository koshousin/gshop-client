  ...
  <div class="shop-info">
    <div class="info-content">
      ...
      <section class="section">
        ...
        <div class="activity">
          <div class="activity-item" :class="colorClass[item.type]" v-for="(item , index) in info['supports']" :key="index">
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        colorClass : ['activity-green' , 'activity-orange' , 'activity-red']  // 0 / 1 /2
      }
    } ,
    watch : {
      info(){   // 刷新流程 --> 更新数据
    ...
    methods : {
      _initScroll (){
        ...
        const pics = this.$refs.pics
        const picArr = document.getElementsByClassName('pic-item')
        pics.style.width = 126  * picArr.length - 6 + 'px'
