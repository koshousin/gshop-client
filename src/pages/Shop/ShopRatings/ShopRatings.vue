  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        ...
        <span class="block positive"  @click="changeFilter(2)"
              :class="{active : 2 === filterType}">
          全部
        <span class="count">{{ratings.length}}</span>
        </span>
        <span class="block positive" @click="changeFilter(0)"
              :class="{active : 0 === filterType}">
          满意
        <span class="count">{{positive}}</span>
        </span>
        <span class="block negative" @click="changeFilter(1)"
              :class="{active : 1 === filterType}">
          不满意
        <span class="count">{{negative}}</span>
        </span>
        </div>
        <div class="switch" @click="toggleShowText"
...
<script>
  ...
  export default {
    ...
    data(){
      return{
        filterType : 2 ,   //  选择类型： 0 满意 ，1不满意， 2 全部
    ...
    computed : {
      ...
      filterRatings (){
        const {ratings , onlyShowText , filterType} = this
        // 根据点击按钮过滤显示评价
        /*
        *   条件1 ：
        *     filterType 0/1/2
        ...
        */
        ...
        return ratings.filter(rate => {
          ...
          return (filterType===2 || filterType===rateType) && (!onlyShowText || text.length > 0)
        })
      }
    } ,
    mounted (){
